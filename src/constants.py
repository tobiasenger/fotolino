...
# Custom event types (defined at import time, before pygame.init)
BUTTON_EVENT = pygame.USEREVENT + 1       # GPIO or keyboard button press
SCREEN_TRANSITION = pygame.USEREVENT + 2  # Request a screen change
